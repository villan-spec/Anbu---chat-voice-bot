...
export const MicrophoneIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M12 16.5c-2.49 0-4.5-2.01-4.5-4.5h2c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5h2c0 2.49-2.01 4.5-4.5 4.5z" />
    <path d="M17 12h-2v-1h2v1zm-1-3.5c0 .28-.22.5-.5.5s-.5-.22-.5-.5V6h1v2.5zM12 2a4 4 0 0 0-4 4v6a4 4 0 0 0 8 0V6a4 4 0 0 0-4-4z" />
  </svg>
);
